...
command = "sudo docker ps -aq -f ancestor=%s" % image  # Docker command to get the list of already running instances of the image mozart-1.4.0
...
os.system("resources/build.sh " + args)
